...
if (document.getElementById('form_edit_candidate')) {
  ...
  document.getElementById('btn_create_experience').addEventListener('click', function () {
    document.getElementById('form_store_experience').style.display = "block";
  });
  document.getElementById('x_store_experience').addEventListener('click', function () {
    document.getElementById('form_store_experience').style.display = "none";
  }); // Edit experience

  var btn_experience = document.querySelectorAll('.btn_experience');
  btn_experience.forEach(function (btn) {
    var attr = btn.getAttribute('name');
    btn.addEventListener('click', function () {
      document.getElementById('form_edit_experience_' + attr).style.display = "block";
    });
  });
  var x_experience = document.querySelectorAll('.x_edit_experience');
  x_experience.forEach(function (x) {
    var attr = x.getAttribute('name');
    x.addEventListener('click', function () {
