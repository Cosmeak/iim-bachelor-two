...
@section('content')
    <section class="w-screen h-screen overflow-hidden relative">
        <section class=" mt-28 text-xl flex items-center flex-col">
            <div class="hidden xl:block rounded-full w-2xl h-2xl bg-primary absolute -right-52 -top-64 border-2 border-blue-400">
            </div>
            <div class="hidden xl:block rounded-full w-2xl h-2xl bg-primary absolute -left-96 border-2 border-blue-400">
            </div>
            <div class="hidden xl:block rounded-md w-2xl h-2xl bg-primary absolute right-52 top-3/4 border-2 border-blue-400">
            </div>
            <div class=" w-sm h-sm rounded-full mb-6 bg-gray-50">
                <img src="../img/logo.png" alt="logo">
            </div>
            <h1 class=" text-center text-3xl ">Inscrivez-vous</h1>
            <form class="flex flex-col xl:w-5xl xl:px-64 justify-center items-center" method="POST"
                ...
                <div id="content_inscription_1" class="flex xl:flex-row flex-col justify-center items-center xl:h-xl">
                    <div class="flex flex-wrap justify-center xl:justify-start">
                        ...
                        <div class="flex flex-col items-start mx-16 my-4">
                            ...
                            <input class="btn-primary text-gray-400" type="date" placeholder="Date de Naissance"
                                name="birth_date">
                            @error('birth_date')
                                <p class="text-red-500 mt-2">{{ $message }}</p>
                            @enderror
                ...
                <div id="submit_inscription" class=" hidden flex-col">
                    ...
                    <a id="back_inscription"
                        class=" w-sm cursor-pointer text-gray-500 text-center mb-4 hover:text-black">Retour </a>
                </div>
                <p>Déjà un compte Easy Apply ? <a href="{{ route('login.index') }}"
                        class="blue-underline text-light-blue font-bold">Connexion</a></p>
