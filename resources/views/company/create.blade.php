            ...
            <form class="flex flex-col px-8 pb-10 pt-32  bg-white relative shadow-md rounded-lg xl:w-xl xl:h-2xl"
                ...
                <section id="content_inscription_1" class="flex flex-col justify-center items-center px-16 h-xl">
                    ...
                    <div class="flex flex-col items-start my-4">
                        ...
                        <textarea class="resize-none btn-primary py-4 h-tiny" type="text" name="description" value="{{ old('description') }}"> </textarea>
                        @error('description')
                            <p class="text-red-500 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
              ...
              <div id="next_inscription_3" class="hidden justify-between mt-auto">
                ...
                <section id="content_inscription_4" class="hidden flex-col justify-center items-center px-16 h-xl">
                    <div class="flex flex-col items-start my-4">
                        ...
                        <input type="file" class=" rounded-xl py-24 px-8 border-2 border-slate-600 border-dashed bg-white"name="logo">
                        @error('logo')
                            <p class="text-red-500 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
